...
class Type(Structure):
    ...
    def get_offset(self, fieldname):
        ...
        """
        return conf.lib.clang_Type_getOffsetOf(self, c_interop_string(b(fieldname)))
...
class TranslationUnit(ClangObject):
    ...
    def from_source(cls, filename, args=None, unsaved_files=None, options=0,
        ...
        ptr = conf.lib.clang_parseTranslationUnit(index,
                                    b(fspath(filename)) if filename is not None else None,
                                    args_array,
    ...
    def from_ast_file(cls, filename, index=None):
        ...
        ptr = conf.lib.clang_createTranslationUnit(index, b(fspath(filename)))
        if not ptr:
    ...
    def save(self, filename):
        ...
        result = int(conf.lib.clang_saveTranslationUnit(self, b(fspath(filename)),
                                                        options))
        if result != 0:
    ...
    def codeComplete(self, path, line, column, unsaved_files=None,
        ...
        if len(unsaved_files):
            ...
            for i,(name,value) in enumerate(unsaved_files):
                ...
                unsaved_files_array[i].contents = b(value)
                unsaved_files_array[i].length = len(value)
        ptr = conf.lib.clang_codeCompleteAt(self, b(fspath(path)), line, column,
...
class File(ClangObject):
    ...
    def from_name(translation_unit, file_name):
        ...
        return File(conf.lib.clang_getFile(translation_unit, b(fspath(file_name))))
...
class CompilationDatabase(ClangObject):
    ...
    def fromDirectory(buildDir):
        ...
        errorCode = c_uint()
        try:
            cdb = conf.lib.clang_CompilationDatabase_fromDirectory(b(fspath(buildDir)),
                byref(errorCode))
